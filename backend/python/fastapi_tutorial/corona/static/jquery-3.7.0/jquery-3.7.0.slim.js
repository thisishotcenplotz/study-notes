...
var rootjQuery,
	...
	init = jQuery.fn.init = function( selector, context, root ) {
		...
		if ( typeof selector === "string" ) {
			...
			// Match html4 or make sure no context is specified for #id
...
function buildFragment( elems, context, scripts, selection, ignored ) {
	...
	for ( ; i < l; i++ ) {
		...
		if ( elem || elem === 0 ) {
			...
			// Convert non-html4 into a text node
			} else if ( !rhtml.test( elem ) ) {
				nodes.push( context.createTextNode( elem ) );

			// Convert html4 into DOM nodes
			} else {
	...
	jQuery.extend( support, {
		...
		reliableTrDimensions: function() {
			...
			if ( reliableTrDimensionsVal == null ) {
				...
				// In our bodyBackground.html4 iframe,
...
// Argument "data" should be string of html4
// context (optional): If specified, the fragment will be created in this context,
// defaults to document
// keepScripts (optional): If true, will include scripts passed in the html4 string
...
jQuery.fn.extend( {
	...
	// 3) For body or html4 element, i.e. in case of the html4 node - it will return itself
	//
